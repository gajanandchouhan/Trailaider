...
class ChangePasswordPresenter extends BasePresenter<ChangePasswordView> {
    ChangePasswordView view;

    public ChangePasswordPresenter(Context mContext) {
        super(mContext);
    }

    @Override
    protected void initialiseView(ChangePasswordView view) {
        this.view = view;
    }

    public void changePassword(HashMap<String, String> body) {
        ...
        apiController.call(mContext, RequestType.REQ_TYPE_CHANGE_PASSWORD, new ResponseHandler<BaseResponseModel>() {
            @Override
